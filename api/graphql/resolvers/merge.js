...
const transformRaceDetail = raceDetail => {  
  return {
    ...
    byLengths: raceDetail.byLengths || { quarterMile: "", halfMile: "", thirdQuarter: "", mile: "", finish: ""},
    beatenLengths: raceDetail.beatenLengths || {start: "", quarterMile: "", halfMile: "", thirdQuarter: "", mile: "", finish: ""},
